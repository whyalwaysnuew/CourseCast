                        ...
                        <div class="col-lg-6 col-12">
                            <form action="{{route('checkout.store', $camp->id)}}" class="basic-form" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="phone" type="number" class="form-control {{$errors->has('phone') ? 'is-invalid' : '' }}" value="{{old('phone') ?: Auth::user()->phone}}">
                                    @if ($errors->has('phone'))
                                ...
                                <p class="text-center subheader mt-4">
                                    <img src="{{asset('assets/ic_secure.svg')}}" alt=""> Your payment is secure and encrypted.
                                </p>
                            </form>
                        </div>
                    </div>
